        ...
        if self.indicator == 'registration':
            if msg['text'] == '/start':
                ...
                if flag:
                    ...
                    bot.sendMessage(chat_id, 'Hi, we are Data-enabled design Mood Team 10. This is the data-collecting telegram bot run by MoodTeam10. You can contact @NeptuneTang or on our Teams channel if something serious happens. Our research goal is to find out the relationship between stress eating, flavor and mood. Do you want to register in the test?', reply_markup=mark_up)
                self.step = 'none'
            elif msg['text'] == 'yes':
                ...
                bot.sendMessage(chat_id, "Please choose your preference time in the evening for input reminder:",
            ...
            bot.sendMessage(chat_id,
                            text='Do you remember what kind of snacks did you have today? If yes, please specify (some) names of the snack. If not, please click /no')
            ...
            bot.sendMessage(chat_id,
                            text='Do you have any comments on the snack corner? For example, why (not) try the snacks today? Do you try some other snacks outside our snack corner? If not, please click /none')
            ...
            bot.sendMessage(chat_id, 'Message Accepted. Thank you very much again for the input. Have a nice evening:)')
